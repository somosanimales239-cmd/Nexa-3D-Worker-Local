...
function fillConfig(cfg){
  ...
  $('sf3dRepo').value=cfg.stable_fast_3d_repo||''; $('sf3dPython').value=cfg.stable_fast_3d_python||''; $('hfToken').value=cfg.has_hf_token?'••••••••••••••••':''; $('hunyuanUrl').value=cfg.hunyuan3d_api_url||'';
